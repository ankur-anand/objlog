...
var (
	...
	ErrRecordExceedsInflightBudget = errors.New("writer: record exceeds inflight byte budget")
	...
	ErrSegmentCommitIndeterminate  = errors.New("writer: segment commit outcome unknown")
