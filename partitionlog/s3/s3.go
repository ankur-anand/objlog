...
import (
	...
	s3sink "github.com/ankur-anand/objlog/partitionlog/blob/sink/s3"
	s3source "github.com/ankur-anand/objlog/partitionlog/blob/source/s3"
	"github.com/ankur-anand/objlog/partitionlog/catalog"
	catalogblob "github.com/ankur-anand/objlog/partitionlog/catalog/blob"
	s3catalog "github.com/ankur-anand/objlog/partitionlog/catalog/blob/s3"
...
func normalizeStreamID(streamID string) (string, error) {
	...
	if err != nil {
		return "", fmt.Errorf("partitionlog/s3: %w", err)
	}
	return streamID, nil
}
